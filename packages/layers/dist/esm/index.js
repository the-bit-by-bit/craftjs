...
import m from 'react-contenteditable';
...
var H = a.createElement('path', {
  ...
  B = function (e) {
    return a.createElement('svg', _({ viewBox: '0 0 10 6' }, e), H);
  },
  S = function () {
    var e = k().id,
      n = p(function (n) {
      ...
      a.createElement(
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            null,
            o && o.length
              ? a.createElement(Z, { expanded: r }, a.createElement(B, null))
              : null
          )
        )
      )
